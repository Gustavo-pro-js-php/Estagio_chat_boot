    ...
    try {
        if (option === '1') {
            ...
            if (pdfPage) {
                ...
                // --- CORREÇÃO AQUI: USANDO setTimeout DENTRO DE UMA PROMISE ---
                await new Promise(resolve => setTimeout(resolve, 3000)); // Espere 3 segundos
                console.log('Tempo de espera para o visualizador de PDF concluído.');
